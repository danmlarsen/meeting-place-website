  ...
  return (
    ...
    >
      <Link
        ...
        className={cn(
          "lg:from-cream-100 lg:to-cream-100 block lg:bg-linear-to-r lg:from-0% lg:to-50% lg:px-[4.5rem] lg:py-9 lg:transition-colors lg:duration-500",
      ...
      {showRightDivider && (
        <div className="bg-border absolute inset-y-0 right-0 my-[3.75rem] hidden w-0.5 lg:block" />
      )}
    </m.li>
  );
}
